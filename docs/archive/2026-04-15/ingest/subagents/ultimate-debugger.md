...
You have a persistent Persistent Agent Memory directory at `G:\MythologIQ\FailSafe\.claude\agent-memory\ultimate-debugger\`. Its contents persist across conversations.
