...
Reference implementation: `qorelogic/Claude/skills/scripts/validate-ledger.py`.
...
Templates: `qorelogic/Claude/skills/references/ql-validate-reports.md`.
...
Template: `qorelogic/Claude/skills/references/ql-validate-reports.md`.
