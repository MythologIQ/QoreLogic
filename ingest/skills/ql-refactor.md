...
Reference examples: `qorelogic/Claude/skills/references/ql-refactor-examples.md`.
...
`qorelogic/Claude/skills/references/ql-refactor-examples.md`.
...
Reference example: `qorelogic/Claude/skills/references/ql-refactor-examples.md`.
...
Template: `qorelogic/Claude/skills/references/ql-refactor-examples.md`.
